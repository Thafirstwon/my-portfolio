...
const CardGrid = () => {
  return (
    ...
    className="relative overflow-hidden border-b border-white/10 min-h-screen pb-32">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-white dark:from-[#0d0e0f] via:white dark:via-[#111217] to-white dark:to-[#141519] animate-gradientMove"></div>

      {/* Content Layer */}
      <div className="relative z-10 text-black dark:text-white pb-24 sm:pb-32 px-5">
        {/* Header */}
        <motion.h2
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {tools.map((tool, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group relative bg-white dark:bg-[#111214]/70 text-black dark:text-white flex flex-col justify-center items-center 
            ...
            >
              ...
              <div className="absolute inset-0 flex justify-center items-center opacity-0 transform scale-75 
                ...
                <i className={`${tool.icon} text-5xl sm:text-6xl md:text-7xl text-black dark:text-white`}></i>
              </div>
