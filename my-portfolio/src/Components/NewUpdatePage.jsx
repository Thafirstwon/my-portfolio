...
const NewUpdatePage = () => {
  ...
  return (
    <div className="overflow-hidden bg-white dark:bg-[#0d0e0f] text-black dark:text-white">
      <div className="min-h-screen px-3 sm:px-5 lg:px-5 py-20 overflow-hidden">
        ...
        {/* BORDER LINE */}
        <div className="relative left-1/2 right-1/2 -mx-[50vw] w-screen border-t border-black dark:border-white mb-6 sm:mb-8"></div>
